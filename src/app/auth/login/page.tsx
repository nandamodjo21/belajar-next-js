    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-white">
            <div className="w-full max-w-md px-6 py-8 bg-white rounded-lg shadow-lg">
                <h3 className="text-4xl font-bold text-black text-center mb-6">Sign In</h3>
                <p className="text-base text-gray-600 text-center mb-8">Enter your email and password to sign in!</p>
                ...
                <div className="mt-4 text-center">
                    ...
                    <Link href="/auth/register" className="text-sm text-indigo-500 hover:text-indigo-700 ml-1">Create an account</Link>
                </div>
            </div>
        </div>
    );
